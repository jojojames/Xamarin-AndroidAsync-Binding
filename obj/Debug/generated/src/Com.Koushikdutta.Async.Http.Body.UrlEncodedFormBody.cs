...
namespace Com.Koushikdutta.Async.Http.Body {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']"
	[global::Android.Runtime.Register ("com/koushikdutta/async/http/body/UrlEncodedFormBody", DoNotGenerateAcw=true)]
	public partial class UrlEncodedFormBody : global::Java.Lang.Object, global::Com.Koushikdutta.Async.Http.Body.IAsyncHttpRequestBody {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/koushikdutta/async/http/body/UrlEncodedFormBody", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UrlEncodedFormBody); }
		}

		protected UrlEncodedFormBody (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/constructor[@name='UrlEncodedFormBody' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe UrlEncodedFormBody ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (UrlEncodedFormBody)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/constructor[@name='UrlEncodedFormBody' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;org.apache.http.NameValuePair&gt;']]"
		[Register (".ctor", "(Ljava/util/List;)V", "")]
		public unsafe UrlEncodedFormBody (global::System.Collections.Generic.IList<global::Org.Apache.Http.INameValuePair> p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/constructor[@name='UrlEncodedFormBody' and count(parameter)=1 and parameter[1][@type='com.koushikdutta.async.http.Multimap']]"
		[Register (".ctor", "(Lcom/koushikdutta/async/http/Multimap;)V", "")]
		public unsafe UrlEncodedFormBody (global::Com.Koushikdutta.Async.Http.Multimap p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Koushikdutta.Async.Http.Body.UrlEncodedFormBody __this = global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Http.Body.UrlEncodedFormBody> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string ContentType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/method[@name='getContentType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/method[@name='get' and count(parameter)=0]"
		[Register ("get", "()Lcom/koushikdutta/async/http/Multimap;", "GetGetHandler")]
		public virtual unsafe global::Com.Koushikdutta.Async.Http.Multimap Get ()
		{
			if (id_get == IntPtr.Zero)
				id_get = JNIEnv.GetMethodID (class_ref, "get", "()Lcom/koushikdutta/async/http/Multimap;");
			try {

				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Http.Multimap> (JNIEnv.CallObjectMethod  (Handle, id_get), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Http.Multimap> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "get", "()Lcom/koushikdutta/async/http/Multimap;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/method[@name='length' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/method[@name='parse' and count(parameter)=2 and parameter[1][@type='com.koushikdutta.async.DataEmitter'] and parameter[2][@type='com.koushikdutta.async.callback.CompletedCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='UrlEncodedFormBody']/method[@name='readFullyOnRequest' and count(parameter)=0]"
