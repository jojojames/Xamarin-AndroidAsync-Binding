...
namespace Com.Koushikdutta.Async.Http.Body {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']"
	[global::Android.Runtime.Register ("com/koushikdutta/async/http/body/JSONArrayBody", DoNotGenerateAcw=true)]
	public partial class JSONArrayBody : global::Java.Lang.Object, global::Com.Koushikdutta.Async.Http.Body.IAsyncHttpRequestBody {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/koushikdutta/async/http/body/JSONArrayBody", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (JSONArrayBody); }
		}

		protected JSONArrayBody (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']/constructor[@name='JSONArrayBody' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe JSONArrayBody ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (JSONArrayBody)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']/constructor[@name='JSONArrayBody' and count(parameter)=1 and parameter[1][@type='org.json.JSONArray']]"
		[Register (".ctor", "(Lorg/json/JSONArray;)V", "")]
		public unsafe JSONArrayBody (global::Org.Json.JSONArray p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			try {
				...
				if (GetType () != typeof (JSONArrayBody)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lorg/json/JSONArray;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lorg/json/JSONArray;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lorg_json_JSONArray_, __args);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Koushikdutta.Async.Http.Body.JSONArrayBody __this = global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Http.Body.JSONArrayBody> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string ContentType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']/method[@name='getContentType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']/method[@name='get' and count(parameter)=0]"
		[Register ("get", "()Lorg/json/JSONArray;", "GetGetHandler")]
		public virtual unsafe global::Org.Json.JSONArray Get ()
		{
			if (id_get == IntPtr.Zero)
				id_get = JNIEnv.GetMethodID (class_ref, "get", "()Lorg/json/JSONArray;");
			try {

				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Org.Json.JSONArray> (JNIEnv.CallObjectMethod  (Handle, id_get), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Org.Json.JSONArray> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "get", "()Lorg/json/JSONArray;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']/method[@name='length' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']/method[@name='parse' and count(parameter)=2 and parameter[1][@type='com.koushikdutta.async.DataEmitter'] and parameter[2][@type='com.koushikdutta.async.callback.CompletedCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='JSONArrayBody']/method[@name='readFullyOnRequest' and count(parameter)=0]"
