...
namespace Com.Koushikdutta.Async {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.koushikdutta.async']/interface[@name='AsyncSocket']"
	[Register ("com/koushikdutta/async/AsyncSocket", "", "Com.Koushikdutta.Async.IAsyncSocketInvoker")]
	public partial interface IAsyncSocket : global::Com.Koushikdutta.Async.IDataEmitter, global::Com.Koushikdutta.Async.IDataSink {

		global::Com.Koushikdutta.Async.AsyncServer Server {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async']/interface[@name='AsyncSocket']/method[@name='getServer' and count(parameter)=0]"
			[Register ("getServer", "()Lcom/koushikdutta/async/AsyncServer;", "GetGetServerHandler:Com.Koushikdutta.Async.IAsyncSocketInvoker, AndroidAsyncBinding")] get;
		}

	}

	[global::Android.Runtime.Register ("com/koushikdutta/async/AsyncSocket", DoNotGenerateAcw=true)]
	internal class IAsyncSocketInvoker : global::Java.Lang.Object, IAsyncSocket {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/koushikdutta/async/AsyncSocket");
		IntPtr class_ref;

		public static IAsyncSocket GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IAsyncSocket> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.koushikdutta.async.AsyncSocket"));
			return handle;
		}
		...
		public IAsyncSocketInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
		...
		protected override System.Type ThresholdType {
			get { return typeof (IAsyncSocketInvoker); }
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Koushikdutta.Async.IAsyncSocket __this = global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.IAsyncSocket> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
