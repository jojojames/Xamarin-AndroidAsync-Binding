...
namespace Com.Koushikdutta.Async.Stream {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']"
	[global::Android.Runtime.Register ("com/koushikdutta/async/stream/InputStreamDataEmitter", DoNotGenerateAcw=true)]
	public partial class InputStreamDataEmitter : global::Java.Lang.Object, global::Com.Koushikdutta.Async.IDataEmitter {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/koushikdutta/async/stream/InputStreamDataEmitter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (InputStreamDataEmitter); }
		}

		protected InputStreamDataEmitter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_koushikdutta_async_AsyncServer_Ljava_io_InputStream_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/constructor[@name='InputStreamDataEmitter' and count(parameter)=2 and parameter[1][@type='com.koushikdutta.async.AsyncServer'] and parameter[2][@type='java.io.InputStream']]"
		[Register (".ctor", "(Lcom/koushikdutta/async/AsyncServer;Ljava/io/InputStream;)V", "")]
		public unsafe InputStreamDataEmitter (global::Com.Koushikdutta.Async.AsyncServer p0, global::System.IO.Stream p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (InputStreamDataEmitter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/koushikdutta/async/AsyncServer;Ljava/io/InputStream;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/koushikdutta/async/AsyncServer;Ljava/io/InputStream;)V", __args);
					return;
				}

				if (id_ctor_Lcom_koushikdutta_async_AsyncServer_Ljava_io_InputStream_ == IntPtr.Zero)
					id_ctor_Lcom_koushikdutta_async_AsyncServer_Ljava_io_InputStream_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/koushikdutta/async/AsyncServer;Ljava/io/InputStream;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_koushikdutta_async_AsyncServer_Ljava_io_InputStream_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_koushikdutta_async_AsyncServer_Ljava_io_InputStream_, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::Com.Koushikdutta.Async.Stream.InputStreamDataEmitter __this = global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Stream.InputStreamDataEmitter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Koushikdutta.Async.Callback.IDataCallback DataCallback {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='getDataCallback' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='setDataCallback' and count(parameter)=1 and parameter[1][@type='com.koushikdutta.async.callback.DataCallback']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Koushikdutta.Async.Callback.ICompletedCallback EndCallback {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='getEndCallback' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='setEndCallback' and count(parameter)=1 and parameter[1][@type='com.koushikdutta.async.callback.CompletedCallback']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsChunked {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='isChunked' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsPaused {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='isPaused' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Koushikdutta.Async.AsyncServer Server {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='getServer' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='charset' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='pause' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.stream']/class[@name='InputStreamDataEmitter']/method[@name='resume' and count(parameter)=0]"
