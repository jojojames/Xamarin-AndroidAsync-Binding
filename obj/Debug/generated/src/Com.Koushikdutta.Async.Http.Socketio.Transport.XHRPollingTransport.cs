...
namespace Com.Koushikdutta.Async.Http.Socketio.Transport {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']"
	[global::Android.Runtime.Register ("com/koushikdutta/async/http/socketio/transport/XHRPollingTransport", DoNotGenerateAcw=true)]
	public partial class XHRPollingTransport : global::Java.Lang.Object, global::Com.Koushikdutta.Async.Http.Socketio.Transport.ISocketIOTransport {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/koushikdutta/async/http/socketio/transport/XHRPollingTransport", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (XHRPollingTransport); }
		}

		protected XHRPollingTransport (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_koushikdutta_async_http_AsyncHttpClient_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/constructor[@name='XHRPollingTransport' and count(parameter)=3 and parameter[1][@type='com.koushikdutta.async.http.AsyncHttpClient'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
		[Register (".ctor", "(Lcom/koushikdutta/async/http/AsyncHttpClient;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe XHRPollingTransport (global::Com.Koushikdutta.Async.Http.AsyncHttpClient p0, string p1, string p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (XHRPollingTransport)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/koushikdutta/async/http/AsyncHttpClient;Ljava/lang/String;Ljava/lang/String;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/koushikdutta/async/http/AsyncHttpClient;Ljava/lang/String;Ljava/lang/String;)V", __args);
					return;
				}

				if (id_ctor_Lcom_koushikdutta_async_http_AsyncHttpClient_Ljava_lang_String_Ljava_lang_String_ == IntPtr.Zero)
					id_ctor_Lcom_koushikdutta_async_http_AsyncHttpClient_Ljava_lang_String_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/koushikdutta/async/http/AsyncHttpClient;Ljava/lang/String;Ljava/lang/String;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_koushikdutta_async_http_AsyncHttpClient_Ljava_lang_String_Ljava_lang_String_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_koushikdutta_async_http_AsyncHttpClient_Ljava_lang_String_Ljava_lang_String_, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::Com.Koushikdutta.Async.Http.Socketio.Transport.XHRPollingTransport __this = global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Http.Socketio.Transport.XHRPollingTransport> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsConnected {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='isConnected' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Koushikdutta.Async.AsyncServer Server {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='getServer' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string SessionId {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='getSessionId' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='disconnect' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='heartbeats' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='send' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='setClosedCallback' and count(parameter)=1 and parameter[1][@type='com.koushikdutta.async.callback.CompletedCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.socketio.transport']/class[@name='XHRPollingTransport']/method[@name='setStringCallback' and count(parameter)=1 and parameter[1][@type='com.koushikdutta.async.http.socketio.transport.SocketIOTransport.StringCallback']]"
