...
namespace Com.Koushikdutta.Async.Http.Body {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']"
	[global::Android.Runtime.Register ("com/koushikdutta/async/http/body/DocumentBody", DoNotGenerateAcw=true)]
	public partial class DocumentBody : global::Java.Lang.Object, global::Com.Koushikdutta.Async.Http.Body.IAsyncHttpRequestBody {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/koushikdutta/async/http/body/DocumentBody", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DocumentBody); }
		}

		protected DocumentBody (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']/constructor[@name='DocumentBody' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DocumentBody ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (DocumentBody)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']/constructor[@name='DocumentBody' and count(parameter)=1 and parameter[1][@type='org.w3c.dom.Document']]"
		[Register (".ctor", "(Lorg/w3c/dom/Document;)V", "")]
		public unsafe DocumentBody (global::Org.W3c.Dom.IDocument p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Koushikdutta.Async.Http.Body.DocumentBody __this = global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Http.Body.DocumentBody> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string ContentType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']/method[@name='getContentType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']/method[@name='get' and count(parameter)=0]"
		[Register ("get", "()Lorg/w3c/dom/Document;", "GetGetHandler")]
		public virtual unsafe global::Org.W3c.Dom.IDocument Get ()
		{
			if (id_get == IntPtr.Zero)
				id_get = JNIEnv.GetMethodID (class_ref, "get", "()Lorg/w3c/dom/Document;");
			try {

				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Org.W3c.Dom.IDocument> (JNIEnv.CallObjectMethod  (Handle, id_get), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Org.W3c.Dom.IDocument> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "get", "()Lorg/w3c/dom/Document;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']/method[@name='length' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']/method[@name='parse' and count(parameter)=2 and parameter[1][@type='com.koushikdutta.async.DataEmitter'] and parameter[2][@type='com.koushikdutta.async.callback.CompletedCallback']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='DocumentBody']/method[@name='readFullyOnRequest' and count(parameter)=0]"
