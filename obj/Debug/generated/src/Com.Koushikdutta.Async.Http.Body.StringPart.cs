...
namespace Com.Koushikdutta.Async.Http.Body {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='StringPart']"
	[global::Android.Runtime.Register ("com/koushikdutta/async/http/body/StringPart", DoNotGenerateAcw=true)]
	public partial class StringPart : global::Com.Koushikdutta.Async.Http.Body.StreamPart {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/koushikdutta/async/http/body/StringPart", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='StringPart']/constructor[@name='StringPart' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe StringPart (string p0, string p1)
...
#pragma warning disable 0169
		...
		{
			global::Com.Koushikdutta.Async.Http.Body.StringPart __this = global::Java.Lang.Object.GetObject<global::Com.Koushikdutta.Async.Http.Body.StringPart> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		protected override unsafe global::System.IO.Stream InputStream {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.koushikdutta.async.http.body']/class[@name='StringPart']/method[@name='getInputStream' and count(parameter)=0]"
